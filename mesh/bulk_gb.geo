...
Point(13) = {0, -1, 2, g_s};
Point(14) = {0, 0, 2, g_s};
Point(15) = {1, 0, 2.1, g_s};
Point(16) = {-1, 0, 2.1, g_s};
Point(17) = {0, 1, 2.1, g_s};
Point(18) = {0, -1, 2.1,g_s};
Point(19) = {0, -1.1, 2.1, g_s};
Point(20) = {0, 1.1, 2.1, g_s};
Point(21) = {1.1, 0, 2.1, g_s};
Point(22) = {-1.1, 0, 2.1, g_s};
Circle(9) = {12, 14, 10};
Circle(10) = {10, 14, 13};
Circle(11) = {13, 14, 11};
Circle(12) = {11, 14, 12};
Point(23) = {0, 0, 2.1, 1.0};
Circle(13) = {17, 23, 15};
Circle(14) = {15, 23, 18};
Circle(15) = {18, 23, 16};
Circle(16) = {16, 23, 17};
