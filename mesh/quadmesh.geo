...
Physical Surface("gb_top") = {112, 110, 108, 114};
Physical Surface("bulk_top") = {40, 34, 42, 36, 38};
...
Transfinite Line {95,96,97,98,99,100,101,102} = 32;

Transfinite Line {5,6,7,8,16,17,18,19} = 32;


Transfinite Line {9,14,15,32,28,29,30,31} = 20;

Transfinite Line {103,104,105,106} = 20;
Transfinite Surface "*";
Recombine Surface "*";
Transfinite Volume "*";
Coherence;
